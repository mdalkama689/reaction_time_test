...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful reaction test time  tool, check it out: https://seosaurus.in/tools/reaction-time-test/"
  );

  const toolUrl = "https://seosaurus.in/tools/reaction-time-test/";
